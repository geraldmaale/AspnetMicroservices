...
public class OrdersController : ControllerBase
{
    ...
    public async Task<IActionResult> GetOrdersByUsername(string username)
    {
        ...
        {
            IsSuccessful = true, Message = "Orders retrieved successfully", Results = result
        });
    }
    ...
    public async Task<IActionResult> CheckoutOrder([FromBody] CheckoutOrderCommand command)
    {
        ...
        {
            IsSuccessful = true, Message = "Order checked out successfully", Result = result
        });
    }
    ...
    public async Task<IActionResult> UpdateOrder([FromBody] UpdateOrderCommand command)
    {
        ...
        {
            IsSuccessful = true, Message = "Order updated successfully"
        });
    }
    ...
    public async Task<IActionResult> DeleteOrder(Guid id)
    {
        ...
        return Ok(new ApiResult
        {
            IsSuccessful = true, Message = "Order deleted successfully"
        });
    }
}
